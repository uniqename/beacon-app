...
class DonationsOverviewScreen extends StatefulWidget {
  const DonationsOverviewScreen({super.key});
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0xFFF0562D).withAlpha(26), Color(0xFFF0562D).withAlpha(13)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: Color(0xFFF0562D).withAlpha(77)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: Color(0xFFF0562D).withAlpha(51),
