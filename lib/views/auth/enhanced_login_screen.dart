            ...
            children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12),
                          borderSide: BorderSide(color: Color(0xFFF0562D)),
                        ),
                      ),
                      validator: (value) {
                    ...
                    Row(
                      children: [
                        ...
                        TextButton(
                          ...
                          child: Text(
                            'Forgot Password?',
                            style: TextStyle(color: Color(0xFFF0562D)),
                          ),
                        ),
                      ],
                    ),
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  style: OutlinedButton.styleFrom(
                    side: BorderSide(color: Color(0xFFF0562D)),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(12),
                    ),
                  ),
                  child: _isLoading
                      ...
                      : Row(
                          ...
                          children: [
                            Icon(Icons.visibility_off, color: Color(0xFFF0562D)),
                            SizedBox(width: 8),
                            Text(
              ...
              Center(
                child: TextButton.icon(
                  ...
                  icon: Icon(Icons.admin_panel_settings, size: 18, color: Colors.red[700]),
                  label: Text(
                    'Administrator Login',
                    style: TextStyle(
