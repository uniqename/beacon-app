...
class _VideoListScreenState extends State<VideoListScreen> {
  List<DevotionalVideo> _displayDevotionals = List.from(_devotionals);
  ...
  Future<void> _loadDbDevotionals() async {
    try {
      ...
      if (rows.isNotEmpty && mounted) {
        final dbItems = rows.map((r) => DevotionalVideo(
          id: r['id'] as String,
          title: r['title'] as String,
          speaker: (r['author'] as String?) ?? 'Beacon',
          description: (r['content'] as String?) ?? '',
          duration: '—',
          videoUrl: '',
          thumbnailColor: const Color(0xFFF0562D),
          date: (r['published_at'] as String?) ?? '',
          category: 'Devotional',
        )).toList();
        setState(() => _displayDevotionals = [...dbItems, ..._devotionals]);
      }
    } catch (_) {}
  }
        ...
        children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${_displayDevotionals.length} devotionals available',
                        style: TextStyle(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemCount: _displayDevotionals.length,
              itemBuilder: (context, index) {
                final d = _displayDevotionals[index];
