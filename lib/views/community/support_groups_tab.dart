          ...
          if (_upcomingRooms.isNotEmpty) ...[
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Icon(Icons.schedule, color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.6), size: 20),
                    const SizedBox(width: 8),
                    Text(
                      'UPCOMING SESSIONS',
                      style: TextStyle(
          ...
          if (_regularGroups.isNotEmpty) ...[
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Icon(Icons.groups, color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.6), size: 20),
                    const SizedBox(width: 8),
                    Text(
                      'ONGOING GROUPS',
                      style: TextStyle(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                Navigator.pop(context);
                // Navigate to AudioRoomScreen — refresh list on return
                Navigator.push(
                  context,
                  MaterialPageRoute(
                  ...
                  if (context.mounted) {
                    final tab = context.findAncestorStateOfType<_SupportGroupsTabState>();
                    tab?._loadGroups();
                  }
                });
              },
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        entry.value,
                        style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.6), height: 1.4),
                      ),
                    ),
                  ],
                ),
