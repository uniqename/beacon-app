...
class DivisionDetailScreen extends StatefulWidget {
  ...
  const DivisionDetailScreen({super.key, required this.division});
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            ListTile(
              leading: Icon(Icons.phone, color: Color(0xFFF0562D)),
              title: Text('Call'),
            ...
            ListTile(
              leading: Icon(Icons.email, color: Color(0xFFF0562D)),
              title: Text('Email'),
            ...
            ListTile(
              leading: Icon(Icons.message, color: Color(0xFFF0562D)),
              title: Text('Message'),
            ...
            _buildDonationOption('Donate Items', 'In-kind donations', Icons.inventory, () {
              ...
              showDialog(
                ...
                builder: (context) => AlertDialog(
                  ...
                  content: Text(
                    'Thank you for your interest in donating items! '
                    'Please contact us directly to arrange in-kind donations.\n\n'
                    'We accept:\n'
