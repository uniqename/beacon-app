...
class ServiceDivisionsScreen extends StatefulWidget {
  ...
  const ServiceDivisionsScreen({super.key, this.initialFilter});
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isSelected ? Color(0xFFF0562D) : Colors.white.withValues(alpha: 0.3),
              width: 2,
            ),
          ),
          child: Column(
            ...
            children: [
              ...
              Text(
                label,
                style: TextStyle(
                  color: isSelected ? Color(0xFFF0562D) : Colors.white,
