class AppConstants {
  ...
  static const Map<String, String> emergencyContacts = {
    ...
    'Fire Service': '192',
    'Ambulance': '193',
    'Domestic Violence Hotline': '0302666758', // DOVVSU Ghana Police
    'Crisis Support': '080000000', // Ghana Mental Health Authority Crisis Line
  };
  ...
  static const String privacyPolicyUrl = 'https://beacon-privacy.netlify.app';
  static const String termsOfServiceUrl = 'https://beacon-privacy.netlify.app';
