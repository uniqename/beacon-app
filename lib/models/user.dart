...
class AppUser {
  ...
  // Helper approval fields (for counselor/volunteer)
  ...
  factory AppUser.fromMap(Map<String, dynamic> map) {
    return AppUser(
      ...
      phoneNumber: map['phone'], // Match database column name
      ...
      lastLoginAt: map['last_updated'] != null
      ...
      approvalNotes: map['approval_notes'],
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'phone': phoneNumber, // Match database column name
      'user_type': userType.toString().split('.').last,
      'is_anonymous': isAnonymous ? 1 : 0,
      'created_at': createdAt.toIso8601String(),
      'last_updated': lastLoginAt?.toIso8601String(), // Match database column name
