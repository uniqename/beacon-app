...
class DemoAuthService extends ChangeNotifier {
  ...
  Future<AppUser?> registerWithEmailAndPassword({
    ...
    try {
      ...
      developer.log('Demo: Registration successful for $email');
      return appUser;
    } catch (e) {
  ...
  Future<AppUser?> signInWithEmailAndPassword({
    ...
    try {
      developer.log('Demo: Attempting login for $email...');
      ...
      developer.log('Demo: Login successful for $email');
      return appUser;
    } catch (e) {
  ...
  Future<void> _saveAnonymousStatus(bool isAnonymous) async {
    try {
      ...
      developer.log('Demo: Error saving anonymous status: $e');
    }
  }
  ...
  Future<bool> isAnonymousUser() async {
    try {
      ...
      developer.log('Demo: Error checking anonymous status: $e');
      return false;
    }
  }
}