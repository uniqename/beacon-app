...
class AccessibilityService extends ChangeNotifier {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      developer.log('Error initializing accessibility service: $e');
      _isInitialized = true;
    }
  }
  ...
  Future<void> setFontSize(double multiplier) async {
    ...
    try {
      ...
      developer.log('Error saving font size: $e');
    }
  }
  ...
  Future<void> setHighContrastMode(bool enabled) async {
    ...
    try {
      ...
      developer.log('Error saving high contrast mode: $e');
    }
  }
  ...
  Future<void> resetToDefaults() async {
    ...
    try {
      ...
      developer.log('Error resetting accessibility settings: $e');
    }
  }
