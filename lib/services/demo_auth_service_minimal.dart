...
class DemoAuthService extends ChangeNotifier {
  ...
  Future<AppUser?> signInAnonymously() async {
    try {
      developer.log('Demo: Attempting anonymous sign in...');
      ...
      developer.log('Demo: Anonymous sign in successful');
      return appUser;
    } catch (e) {
      developer.log('Demo: Error signing in anonymously: $e');
      return null;
    }
  }
  ...
  Future<AppUser?> registerWithEmailAndPassword(
    ...
    try {
      developer.log('Demo: Attempting registration for $email...');
      ...
      developer.log('Demo: Registration successful');
      return appUser;
    } catch (e) {
      developer.log('Demo: Error registering: $e');
      return null;
    }
  }
  ...
  Future<AppUser?> signInWithEmailAndPassword(String email, String password) async {
    try {
      developer.log('Demo: Attempting sign in for $email...');
      ...
      developer.log('Demo: Sign in successful');
      return appUser;
    } catch (e) {
      developer.log('Demo: Error signing in: $e');
      return null;
    }
  }
  ...
  Future<void> signOut() async {
    try {
      developer.log('Demo: Signing out...');
      ...
      developer.log('Demo: Sign out successful');
    } catch (e) {
      developer.log('Demo: Error signing out: $e');
    }
  }
  ...
  Future<void> updateUserProfile(AppUser user) async {
    try {
      developer.log('Demo: Updating user profile...');
      ...
      developer.log('Demo: Profile update successful');
    } catch (e) {
      developer.log('Demo: Error updating profile: $e');
    }
  }
  ...
  Future<void> resetPassword(String email) async {
    try {
      developer.log('Demo: Sending password reset email to $email...');
      
      // Simulate network delay
      await Future.delayed(const Duration(milliseconds: 1000));
      
      developer.log('Demo: Password reset email sent');
    } catch (e) {
      developer.log('Demo: Error resetting password: $e');
    }
  }
